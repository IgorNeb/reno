 ...
 *
 * Autor: Josй Manuel Busto Lуpez
 * Version: 1.1
 * Fecha: 04-05-2007
 * Licencia: Lesser General Public License (LGPL)
 *
 * Copyright (C) 2007  Josй Manuel Busto Lуpez
...
class AES {
    ...
    /* Definiciуn de la S-box inversa (para el descifrado) */
    var $Si = array(
    ...
    /* Definiciуn de los valores de la funciуn rcon */
    var $rcon = array (
    ...
    var $Nr=10;//Nъmero de rondas 128b=>10

    var $Nb=4;//Nъmero de columnas en el state (siempre 4)
   ...
   /**
     ...
     * @param debug Si es verdadero muestra informaciуn de debug
     */
