...
{
	/**
	 * id ыерсии, которую необходимо отобразить на странице
	 *
	 * @var int
	 */
	private $cvs_id = 0;
	...
	/**
     * Добавление ссылки в административную панель
     * 
    ...
    /**
     * Добавление разделитиля 
     * 
     * @param string $name
     */
	public function addDivider($name) 
    {
		$this->buttons[] = array('name' => $name, 'type' => 'divider');
	}
	...
	public function cvs($table_name, $id) 
    {
		...
		$query = "
			...
			WHERE tb_log.table_name='$table_name'
