...
//			}
	...
	private function loadAdmin() 
    {
		...
		$query = "
			select
				...
				tb_structure.name_".LANGUAGE_ADMIN_DEFAULT." as name
	...
	public function delete() 
    {
		...
		// К структуре сайта не прикрепляем модуль, потому  не удаляются страницы сайта
	 ...
	 */
	public static function distrib($project_id) 
    {
		global $DB;
