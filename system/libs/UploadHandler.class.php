...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'image_filename'   => UPLOADS_ROOT . $_REQUEST['table'] .'/'. $_REQUEST['field'] .'/'. Uploads::getIdFileDir($_REQUEST['id']) . "." .str_replace('.', '', strrchr($_FILES['file']['name'], '.')),
    ...
    public function post($print_response = true) {
        ...
        $_FILES['file']['name'] = $this->options['image_filename']; //UPLOADS_ROOT . $_REQUEST['table'] .'/'. $_REQUEST['field'] .'/'. Uploads::getIdFileDir($_REQUEST['id']) . "." .str_replace('.', '', strrchr($_FILES['file']['name'], '.'));
        //$_FILES['file']['name'] = $_SESSION['image'] . "." .str_replace('.', '', strrchr($_FILES['file']['name'], '.'));
        $_SESSION['image'] .= "." . str_replace('.', '', strrchr($_FILES['file']['name'], '.'));
