<?php
/**
 * Сохраняет привелегии дл¤ пользователей через Ajax
 * @package Pilot
 * @subpackage CMS
...
// ќтключаем всех пользователей, которые ыбли в этой группе
...
Action::setOk(cms_message('CMS', 'Изменения успешно сохранены. Отключено %d пользователей для обновления настроек.', $DB->rows));
